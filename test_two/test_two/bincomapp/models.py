...
class Lga(models.Model):
    ...
    lga_name = models.ForeignKey(AnnouncedLgaResults, on_delete=models.CASCADE)
    # lga_name = models.CharField(max_length=50)
...
class PollingUnit(models.Model):
    uniqueid = models.AutoField(primary_key=True)
    # polling_unit_id = models.models.ForeignKey(AnnouncedPuResults, on_delete=models.CASCADE)
